...
<html lang="ja">
	<head>
		...
		<script src="/TeraNavi/js/editArticle.js"></script>
					...
					<div class="col-md-8 col-xs-offset-1">
						<div class="row">
							<form action="/TeraNavi/front/editArticle" method="post" id="articleForm" role="form">
								<div class="form-group">
										...
										<input type="text" name="title" class="form-control" id="inputTitle" value="${result.article.title}" style="width: 92%;">
										<!--入力チェックのメッセージ用のdiv-->
										...
										<textarea class="articleEditor" id="inputBody" name="body" rows="30">${result.article.articleBody}</textarea>
						...
						<div class="row">
							...
							<div class="col-md-2 col-xs-4 hidden-xs" style="margin-left: inherit;">
								<button type="button" class="btn btn-lg btn-warning" id="btn_post">変更を保存</button>
							</div>
						</div>
						<div class="col-xs-12 visible-xs" style="margin-top:10px;margin-left: -4%;">
							<button type="button" class="btn btn-block btn-warning" id="mobile_btn_post">変更を保存</button>
						</div>
		...
		<div class="fade modal text-justify" id="editArticleModal">
            ...
            　<h4 class="modal-title text-center">確認</h4>
					...
					<div class="modal-footer" id="editArticleModalFooter">
						<button type="submit" class="btn btn-block btn-warning hidden-xs" id="btn_modalEditArticle" data-dismiss="modal">変更を保存</button>
						<button type="submit" class="btn btn-block btn-warning visible-xs" id="mobile_btn_modalEditArticle" data-dismiss="modal">変更を保存</button>
