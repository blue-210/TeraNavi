  <ul class="nav nav-pills nav-stacked well">
    ...
    <li id="commMgrTab">
      <a href="/TeraNavi/front/commmy?groupBy=group+By+community_members_list.fk_community_id+&where=community_members_list.fk_user_id%3D+%3F+and+communities.community_delete_flag+%3D0+and+%3D0&target=create">コミュニティ管理</a>
    </li>
    <li id="dmTab">
